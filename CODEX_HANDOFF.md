...
- **Vercel production**: implementation commit `0ba6505` (plus documentation-only follow-ups) is deployed and aliased to `outline-manager.vercel.app`. Use `vercel inspect outline-manager.vercel.app` for the current immutable deployment ID.
